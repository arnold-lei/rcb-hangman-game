  ...
  var artistPic = {
    ...
    'Ella Fitzgerald':'ella_fiztgerald.jpg',
    'Artie Shaw':'artie_shaw.jpg',
    'Duke Ellington':'duke_ellington.jpg',
    'Benny Goodman':'benny_goodman.jpg',
    'Gene Krupa':'gene_krupa.png',
    'Jimmie Lunceford':'jimmie_lunceford.jpg',
...
function winCondition(result, name, guess){
  if (result == name) {
    ...
    document.querySelector('.winMsg').innerHTML ='Congratulations you\'ve won!<br/>';
    return true;
  }else if (guess <= 0 ){
    show('fail');
    document.querySelector('.loseMsg').textContent ='Sorry you lost!<br/>';
